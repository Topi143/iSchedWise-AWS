...
__all__ = ['main_bp', 'auth_bp', 'department_bp', 'curriculum_bp', 'faculty_bp', 'building_bp', 'schedule_bp', 'exam_schedule_bp', 'settings_bp', 'user_bp', 'archive_bp', 'reports_bp', 'profile_bp']

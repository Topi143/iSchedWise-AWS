...
| 2 | Did I READ the agent's `.md` file (or recall its rules)? | â†’ STOP. Open `.github/agents/{agent}.md` |
...
> ðŸ”´ **Agents & Skills can invoke ANY script** via `python .github/skills/<skill>/scripts/<script>.py`

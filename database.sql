...
CREATE TABLE `departments` (
  ...
  `full_department_name` VARCHAR(255) NULL DEFAULT NULL COMMENT 'Full official department name (e.g., Department of Computing Studies)',
  `department_logo` VARCHAR(255) NULL DEFAULT NULL COMMENT 'Path to department logo image',
  `secretary_name` VARCHAR(100) NULL DEFAULT NULL COMMENT 'Name of department secretary',
  `is_active` TINYINT(1) NOT NULL DEFAULT 1,
